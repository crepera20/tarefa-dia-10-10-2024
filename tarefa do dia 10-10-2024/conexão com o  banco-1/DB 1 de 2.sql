...
SELECT Numero FROM Duplicatas WHERE Banco = 'ITAU';

SELECT COUNT(Numero) FROM Duplicatas WHERE Banco = 'ITAU';
...
SELECT SUM(Valor) AS PrevisaoRecebimento
FROM Duplicatas
WHERE Vencimento BETWEEN '2016-01-01' AND '2016-12-31';

SELECT SUM(Valor) AS TotalReceber
FROM Duplicatas
...
SELECT AVG(Valor) AS MediaValores
FROM Duplicatas
...
SELECT SUM(Valor) AS TotalSantander
FROM Duplicatas
